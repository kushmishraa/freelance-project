...
export const CartPriceDetails = (props) => {
  const className = {
    cartPriceDetailsContainer: "p-[20px] md:w-[55%] md:pt-[50px] md:pr-[30px]",
    cartPriceDetails: "sticky top-0 ",
    cartPriceDetailsBottom: "p-[20px] flex items-center gap-[10px]",
    cartPriceDetailsBox: "",
  };

  return (
    <div className={className.cartPriceDetailsContainer}>
      <div className={className.cartPriceDetails}>
        <Paper elevation={2} className={className.cartPriceDetailsBox}>
        ...
        <div className={className.cartPriceDetailsBottom}>
          <img
